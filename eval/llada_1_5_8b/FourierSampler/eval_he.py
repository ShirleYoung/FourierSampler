...
with read_base():
    from opencompass.configs.datasets.humaneval.deprecated_humaneval_gen_ff7054 import humaneval_datasets 
...
for wr, bb_min, bb_max in param_grid:
    abbr = f"llada_1_5_8b_fouriersampler"
    fft_cfg = dict(
        enable=True,
        window_ratio=wr,
    ...
    models.append(
        dict(
            ...
            batch_size=1,
            run_cfg=dict(
                num_gpus=num_gpus['llada_1_5_8b'],
                num_procs=num_gpus['llada_1_5_8b'],
            ),
...
work_dir = './outputs/llada_1_5_fouriersampler-b64_s512/'
